...
bulk-deleted. I spot-checked all seven preserved items in `docs/evals/direction-eval-retarget-541-2026-09-17.md`
...
injected-chat retarget "an intentional behaviour change" (`direction-eval-retarget-541-2026-09-17.md:37-39`),
...
`direction-eval-retarget-541-2026-09-17.md` is **not** a runner output and is **not dated**; it is a
...
## DOC ACCURACY (`docs/evals/direction-eval-retarget-541-2026-09-17.md`)
...
**[major]** `docs/evals/direction-eval-retarget-541-2026-09-17.md:89-96` — the flake attribution names
...
**[minor]** `docs/evals/direction-eval-retarget-541-2026-09-17.md` placement — `docs/evals/` follows a
