...
3. [Map #535](https://github.com/CorVous/hi-blue/issues/535) is the tracker of record for the effort. Its remaining children are follow-up work, not Vista implementation; fetch the live issue before starting anything it lists.
