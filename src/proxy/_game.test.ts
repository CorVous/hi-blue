...
// NOTE: The GET /?lockout=1 and GET /?winImmediately=1 worker-side handlers
// were deleted in issue #91. These URL params are now handled by the SPA on
// boot (see src/spa/routes/game.ts — applyTestAffordances). The worker's
// GET / route serves renderChatPage() unconditionally; wrangler v4 asset-
// serving means the worker fetch handler is bypassed for the actual page load
// anyway.
